...
public class FluxAndMonoFactoryTest {
    ...
    public void fluxUsingArray() {
        Flux<String> namesFlux = Flux.fromArray(new String[]{"adam", "anna", "jack", "jenny"});
        StepVerifier.create(namesFlux)
                .expectNext("adam", "anna", "jack", "jenny")
                .verifyComplete();
    }
    ...
    public void fluxFromStream() {
        ...
        StepVerifier.create(namesFlux)
                .expectNext("adam", "anna", "jack", "jenny")
                .verifyComplete(); // This is a terminal operation which will initiate stream to start emitting
    }
